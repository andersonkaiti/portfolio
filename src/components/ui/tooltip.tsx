    ...
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          ...
          'px-3 py-1.5 text-xs font-medium text-foreground text-balance shadow-lg',
      ...
      >
        {children}
        <TooltipPrimitive.Arrow className="fill-border z-50 size-2.5 translate-y-[calc(-50%-2px)] rotate-45 rounded-[2px]" />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  )
}
